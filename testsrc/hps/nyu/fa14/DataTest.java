...
public class DataTest {
  ...
  private void test_sat_file(ISolver solver, String file) throws Exception {
    ...
    assertTrue(String.format("Formula is not satisfied [%s]", file),
        f.isSatisfied(a));
    long elapsed = System.currentTimeMillis() - start;
    assertTrue(String.format("Solution took too long to find [%s]", file),
        elapsed < (MAX_EXECUTION_TIME_SEC * 1000));
  }
